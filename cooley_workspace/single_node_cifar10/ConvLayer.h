...
namespace NeuralNet {
  ...
  extern void __cudaSafeCall( cudaError, const char*, int );
  extern void __cudnnSafeCall( cudnnStatus_t, const char*, int );
  extern void __cublasSafeCall( cublasStatus_t, const char*, int );
  extern void __cudaCheckError( const char *, int );
